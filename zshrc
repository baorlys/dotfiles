...
# Reload Zsh config immediately
alias reload="source ~/.zshrc && echo 'Zsh config reloaded!'"

# Open current folder in Windows Explorer (WSL 2 Magic!)
alias open="explorer.exe ."

# Shortcuts for editing configs
...
alias gb="git branch"
# A beautiful git log graph (Must try!)
alias glog="git log --graph --pretty=format:'%Cred%h%Creset -%C(yellow)%d%Creset %s %Cgreen(%cr) %C(bold blue)<%an>%Creset' --abbrev-commit"

# ==========================================
#  MAVEN & JAVA (Backend Life)
# ==========================================
# Fast build (skipping tests - use carefully)
...
# ==========================================
#  DOCKER & MICROSERVICES (Native & Clean)
# ==========================================
alias d="docker"
alias dc="docker-compose"

# List containers but prettier (Standard docker ps is too wide)
...
alias dprune="docker system prune -a --volumes"     # Clean up everything (Save disk space)
...
#  NETWORKING & UTILS
# ==========================================
# Check what is running on a port (e.g., check :8080)
# Usage: port 8080
